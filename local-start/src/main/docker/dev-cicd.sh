...
CICD_PATH="./local-start/src/main/docker/$ENV/"
ONEDEV="10.7.103.6:6610"
MACHINE_ID=15
PUBLISH_TYPE="ServerPublish"
SOURSE_PATH="./local-start/src/main/docker/"
FILE_PATH="${SOURSE_PATH}${SERVER_NAME}-${VERSION}.jar"
...
cp ${SOURSE_PATH}/run.sh $CICD_PATH
cd $CICD_PATH
